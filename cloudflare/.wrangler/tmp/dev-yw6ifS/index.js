...
// .wrangler/tmp/bundle-VnQlz8/checked-fetch.js
...
tombola.delete("/participants/:id", async (c) => {
  try {
    ...
    return c.json({
      success: true,
      message: "Compte, participation et toutes les donn\xE9es utilisateur supprim\xE9s"
    });
  } catch (error) {
...
// .wrangler/tmp/bundle-VnQlz8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-VnQlz8/middleware-loader.entry.ts
