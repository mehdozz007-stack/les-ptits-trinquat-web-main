...
// .wrangler/tmp/bundle-v2lkLp/checked-fetch.js
  ...
  try {
    ...
    for (const subscriber of subscribers.results) {
      try {
        ...
        const logoUrl = c.env.ENVIRONMENT === "development" ? "https://lespetitstrinquat.fr/logoAsso.png" : `${c.env.SITE_URL}/logoAsso.png`;
        ...
        results.push({
          ...
          success: sendSuccess,
          error: sendSuccess ? void 0 : `HTTP ${response.status}`
        });
        if (sendSuccess) {
          try {
            await c.env.DB.prepare(`
...
// .wrangler/tmp/bundle-v2lkLp/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-v2lkLp/middleware-loader.entry.ts
