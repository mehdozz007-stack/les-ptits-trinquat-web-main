...
import { getLatestActualites, actualiteTypeLabels, actualiteColorClasses, formatDateFr } from "@/lib/actualites";
        ...
        <section className="relative overflow-hidden bg-muted/50 sm:py-12 py-20 md:py-28">
            <div className="container">
                ...
                <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="mt-12 text-center flex justify-center scale-75 sm:scale-90 md:scale-100 origin-center"
                >
