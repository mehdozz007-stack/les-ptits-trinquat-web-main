...
export function HeroSection() {
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="relative mb-6 inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2 text-lg font-bold text-blue-900 overflow-visible"
            >
              {/* Dynamic Sparks */}
              {sparks.map((_, i) => (
              <Spark
              ...
              {/* Ping indicator */}
              📣
              <div className="flex items-center gap-3 font-kid text-transparent bg-clip-text 
               bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 
               text-base font-bold leading-tight drop-shadow-lg">
 ...
 {/*          <motion.div
            ...
            >
              ...
              {/* Texte }
              <span>
              Vide grenier du 14 Septembre 2025 : réservez votre emplacement dès maintenant !
              </span>
             </div>
              {/* Link }
                    <Button
...
*/}
            ...
            >
              <div>
                <div className="text-3xl font-bold text-[#A8D479]">100+</div>
                <div className="text-sm text-muted-foreground">Familles</div>
              </div>
              <div className="h-12 w-px bg-border" />
              <div>
                <div className="text-3xl font-bold text-[#E89AB1]">10+</div>
                <div className="text-sm text-muted-foreground">Événements / an</div>
              </div>
              <div className="h-12 w-px bg-border" />
              <div>
                <div className="text-3xl font-bold text-[#87CEEB]">10</div>
                <div className="text-sm text-muted-foreground">Ans d'entraide</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.3 }}
              className="mb-6 text-4xl font-extrabold leading-tight tracking-tight sm:text-4xl md:text-5xl"
            >
              <span className="text-gradient">Les P'tits Trinquât</span>
              <br />
              <p className="text-sm md:text-xl mt-1 font-semibold text-black">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 flex items-center gap-3 rounded-2xl bg-card p-4 shadow-card"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-accent">
                  <Users className="h-6 w-6 text-accent-foreground" />
                </div>
                <div>
                  <div className="text-sm font-bold text-foreground">Communauté active</div>
            ...
            <div className="absolute -right-6 bottom-6 flex flex-col gap-3">
              <a
                ...
                target="_blank"
                className="flex items-center justify-center h-12 w-12 rounded-xl bg-primary text-primary-foreground shadow-md hover:scale-105 transition"
              >
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6"
                  fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.6 3H4.4C3.1 3 2 4.1 2 5.4v13.2C2 19.9 3.1 21 4.4 21h15.2c1.3 0 2.4-1.1 2.4-2.4V5.4C22 4.1 20.9 3 19.6 3zM10 16.5V7.5l6 4.5-6 4.5z"/>
                </svg>
              </a>*/}
            </div>
