...
const bureauMembers = [
  { name: "Cindy", role: "Co-Présidente", emoji: "👩‍⚖️", classe: [10, 15] },
  { name: "Alexia", role: "Co-Présidente", emoji: "👩‍💼", classe: [9] },
  { name: "Mehdi", role: "Co-Secrétaire", emoji: "👨‍💻", classe: [1, 12] },
  { name: "Marie-Claire", role: "Co-Secrétaire", emoji: "📝", classe: [1] },
  { name: "Camille", role: "Co-Trésorière", emoji: "💰", classe: [11] },
  { name: "Julie S", role: "Co-Trésorière", emoji: "🧮", classe: [5, 11] },
  { name: "Nora", role: "Responsable réseaux sociaux", emoji: "📢", classe: [5, 11] },
  { name: "Yasmine", role: "Responsable communication", emoji: "🤝", classe: [2, 4] },
  { name: "Monique", emoji: "🌍", classe: [14] },
  { name: "Jean", emoji: "🎊", classe: [2, 4] },
  { name: "Sana H", emoji: "🎈", classe: [10, 16] },
  { name: "Frédérique", emoji: "🌸", classe: [13] },
  { name: "Linda", emoji: "🎨", classe: [13] },
  { name: "Redha", emoji: "🏆", classe: [14] },
  { name: "Sana A", emoji: "🧸", classe: [3, 14, 17] },
  { name: "Benjamin", emoji: "🎲", classe: [13] },
  { name: "Ophélie", emoji: "🎭", classe: [11] },
  { name: "François", emoji: "⚽", classe: [9] },
  { name: "Céline", emoji: "🦋", classe: [16] },
  { name: "Asma", emoji: "🌺", classe: [4] },
  { name: "Julie C", emoji: "🎶", classe: [14, 17] },
  ...
  { name: "Ghania", emoji: "🎪", classe: [14, 18] },
  { name: "Cassandra", emoji: "🎨", classe: [5] },
  { name: "Mathieu", emoji: "⚽", classe: [11] },
  { name: "Olga", emoji: "🌻", classe: [13] },
  { name: "Zohra", emoji: "🍀", classe: [12] },
  { name: "Feriel", emoji: "🎈", classe: [4, 10] },
  { name: "Morgan", emoji: "🎀", classe: [9] },
  { name: "Rachel", emoji: "🌷", classe: [9, 10, 15] },
  { name: "Clémence", emoji: "🌼", classe: [5, 11] },
  { name: "Lucia", emoji: "🌹", classe: [3] },
  { name: "Olivier", emoji: "♟️", classe: [5] },
  { name: "Isabelle", emoji: "🏵️", classe: [11, 18] },
