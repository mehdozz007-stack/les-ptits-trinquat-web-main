      ...
      <section className="relative overflow-hidden bg-hero py-12 sm:py-16 md:py-20">
        ...
        <div className="container relative">
          ...
          >
            ...
            <p className="inline-flex text-base sm:text-lg text-muted-foreground">
        ...
        <div className="container">
          <div className="grid gap-4 sm:gap-6 md:gap-8 lg:gap-12 lg:grid-cols-2">
            ...
            >
              <Card variant="elevated">
                <CardContent className="p-4 sm:p-6 lg:p-8">
                  <h2 className="mb-4 sm:mb-6 text-lg sm:text-xl md:text-2xl font-bold">Envoyez-nous un message</h2>
                  <form
            ...
            >
              ...
              <Card variant="elevated">
                <CardContent className="flex flex-row items-center justify-between gap-3 sm:gap-4 p-4 sm:p-6">
                  ...
                  <div className="flex gap-2 sm:gap-3">
                    <Button variant="ghost" size="icon" asChild className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 rounded-full bg-pink-200 hover:bg-pink-300">
                      <a href="https://www.instagram.com/Les_ptits_trinquat" target="_blank" rel="noopener noreferrer" title="Instagram">
                        <Instagram className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-pink-600" />
                      </a>
                    </Button>
                    <Button variant="ghost" size="icon" asChild className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 rounded-full bg-sky-200 hover:bg-sky-300">
                      <a href="https://www.facebook.com/LesPtitsTrinquats" target="_blank" rel="noopener noreferrer" title="Facebook">
                        <Facebook className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-sky-600" />
                      </a>
                    </Button>
                  </div>
                </CardContent>
              ...
              <Card variant="elevated">
                <CardContent className="flex flex-col gap-3 sm:gap-4 p-4 sm:p-6">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-xl bg-sky/20">
